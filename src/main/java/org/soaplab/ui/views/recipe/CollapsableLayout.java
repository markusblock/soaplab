...
public class CollapsableLayout extends VerticalLayout {
	 ...
	 *
	 * @param startVisible true starts with content hidden, false starts with
	 *                     content shown
	 */
	 ...
	 *
	 * @return true header clicks toggle state, false header clicks do not toggle
	 *         state.
	 */
	 ...
	 *
	 * @param collapseOnHeaderClick true header clicks toggle state, false header
	 *                              clicks do not toggle state.
	 */
	 ...
	 *
	 * @param visible true content should be visible, false content should be
	 *                hidden.
	 */
	 ...
	 * @param visible    true content should be visible, false content should be
	 *                   hidden.
	 * @param fireEvents true fire collapse state change event, false do not fire
	 *                   events.
	 */
	...
	/**
	 * Adds a header component as last (in the current set of components) and adds a
	 * margin that will push it to the far right.
	 *
	 * @param component the component to add
	 */
	...
	/**
	 * Adds a listener that is triggrered when the visiblity state of the content
	 * changes.
	 *
	 ...
	 */
	public static class CollapseChangedEvent extends ComponentEvent<CollapsableLayout> {

		private static final long serialVersionUID = 1L;
		private boolean wasVisible;
		private boolean currentlyVisible;

		public CollapseChangedEvent(CollapsableLayout source, boolean fromClient, boolean wasVisible,
