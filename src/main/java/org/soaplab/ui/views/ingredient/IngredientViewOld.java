...
@Route(value = "ingredients2", layout = MainAppLayout.class)
public class IngredientViewOld extends VerticalLayout implements BeforeEnterObserver {
	...
	@Autowired
	public IngredientViewOld(IngredientsService ingredientsService) {
